...
export default async function Home() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background relative">
      ...
      {/* Founders Section */}
      <div className="w-full py-24 px-8 bg-muted/30">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <p className="text-sm font-semibold text-primary mb-2 uppercase tracking-wider">Our Team</p>
            <h2 className="text-4xl md:text-5xl font-bold mb-4 text-foreground">
              Built by passionate founders
            </h2>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              We're on a mission to revolutionize how people learn through AI-powered education
            </p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            {/* Founder 1 - Arsh Bansal */}
            <div className="group">
              <Card className="overflow-hidden border-0 shadow-lg hover:shadow-2xl transition-all duration-500 bg-card/50 backdrop-blur-sm">
                ...
                <CardContent className="p-8 text-center">
                  <h3 className="text-2xl font-bold mb-2 text-foreground">Arsh Bansal</h3>
                  <p className="text-primary font-medium mb-4">Co-Founder & CEO</p>
                  <p className="text-sm text-muted-foreground leading-relaxed mb-6">
                    Passionate about education and AI. Building the future of personalized learning.
                  </p>
                  <div className="flex gap-4 justify-center">
            ...
            {/* Founder 2 - Yash Shokeen */}
            <div className="group">
              <Card className="overflow-hidden border-0 shadow-lg hover:shadow-2xl transition-all duration-500 bg-card/50 backdrop-blur-sm">
                <div className="relative w-full aspect-square overflow-hidden">
                  <div className="absolute inset-0 bg-gradient-to-br from-primary/20 via-primary/10 to-transparent" />
                  <Image
                    src="/founders/founder2.jpeg"
                    alt="Yash Shokeen"
                    fill
                    className="object-cover group-hover:scale-110 transition-transform duration-700"
                  />
                ...
                <CardContent className="p-8 text-center">
                  <h3 className="text-2xl font-bold mb-2 text-foreground">Yash Shokeen</h3>
                  <p className="text-primary font-medium mb-4">Co-Founder & CTO</p>
                  <p className="text-sm text-muted-foreground leading-relaxed mb-6">
                    Tech enthusiast and AI researcher. Transforming education with cutting-edge technology.
                  </p>
                  <div className="flex gap-4 justify-center">
                    <a href="#" className="text-muted-foreground hover:text-primary transition-colors">
                      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
